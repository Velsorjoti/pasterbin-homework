...
public class PastaControllerIntegrationTest {
    ...
    private static final String PASTA_HASH = "1d2df34gh7ghj";
    private static final String PASTA_TITLE = "Meow";
    private static final String PASTA_BODY = "Moor";
